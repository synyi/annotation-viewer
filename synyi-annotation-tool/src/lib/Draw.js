...
var Draw = (function () {
    ...
    Draw.prototype.relation = function (id, srcId, dstId, text) {
        ...
        var marker = path.attr('marker-end');
    ...
    Draw.prototype.trackLine = function (label, left, top) {
        ...
        var marker = this.board.trackLine.attr('marker-end');
    ...
    Draw.prototype.repaintMappings = function (states, reset) {
        ...
        for (var _i = 0, _a = this.board.lines['label']; _i < _a.length; _i++) {
            var line = _a[_i];
            for (var _b = 0, line_1 = line; _b < line_1.length; _b++) {
                var label = line_1[_b];
                var id = label.id, category = label.category;
                var _c = this.board.getLabelById(id).svg, rect = _c.rect, highlight = _c.highlight;
                if (reset) {
                    ...
                    switch (states[id]) {
                        case 0:
                            color = colorMap['mapped'];
                            break;
                        case 1:
                            color = colorMap['unmapped'];
                            break;
                        case 2:
